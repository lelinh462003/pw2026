...
- **VS Code** — [Download here](https://code.visualstudio.com/) _(recommended)_
...
| Where to put your end-to-end tests?          | `tests` _(press Enter for default)_ |
| Add a GitHub Actions workflow?               | `false` _(unless you need CI now)_  |
